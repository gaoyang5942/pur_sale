...
// +---------------------------------------------------------------------
// | Copyright (c) 2013-2014 http://www.THINKPHP.com All rights reserved.
// +---------------------------------------------------------------------
...
class Upload
{
    ...
    public function upload()
    {
        ...
        //  $url=$first['url'];
        $storageSetting = cmf_settings('storage');
            ...
            if ($needUploadToRemoteStorage) {
                ...
                if (!empty($result)) {
                    return array_merge([
                        ...
                        'id'          => $strId,
                        'preview_url' => get_root() . '/upload/' . $arrInfo["file_path"],
                        'url'         => get_root() . '/upload/' . $arrInfo["file_path"],
                    ], $result);
                }
            } else {

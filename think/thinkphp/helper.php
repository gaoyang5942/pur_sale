...
if (!function_exists('service')) {
     ...
     * @param string $actionName service方法名
     * @param array $params 参数类名
     * @return array 结果集
     */
    function service($serviceName, $actionName, $params = array())
    {
        $obj    = \think\Loader::model('service/'.$serviceName, 'service');
        $result = $obj->$actionName(...$params);
        return $result;
    }
}

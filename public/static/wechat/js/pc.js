     // $(function(){
		...
		$(document).ready(function(){
			...
			myfunction($(".container1 .menu .ulmenu1 li"),$(".container1 .ulmenu1 li a"),$(".container1 .content .menu1 .tab"));
			myfunction($(".container1 .menu .ulmenu2 li"),$(".container1 .ulmenu2 li a"),$(".container1 .content .menu2 .tab"));
			myfunction($(".container1 .menu .ulmenu3 li"),$(".container1 .ulmenu3 li a"),$(".container1 .content .menu3 .tab"));
			...
			$(function(){            //ul/li的折叠效果
				$(".menu > ul").eq(0).show();
				 $(".menu h3").click(function(){
				 		...
				 		$(".container1 .content .menu"+menu_value+" .tab:first-child").addClass("active");
				 		$(".container1 .menu .ulmenu"+menu_value+" li>a").removeClass("selected");
				 		$(".container1 .menu .ulmenu"+menu_value+" li a").eq(0).addClass("selected");//默认设置为被选中状态
			...
			$(function(){   // 导航 >
				 $(".container1 .menu > h3").click(function(){

				 	$(".container1 .content .A1").empty().text($(this).text());
